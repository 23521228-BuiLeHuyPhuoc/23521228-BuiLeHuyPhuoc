...
```yaml
name: Bui Le Huy Phuoc
student_id: 23521228
university: UIT - HCMC
major: Computer Networks & Communications
...
currently_learning:
  - CCNA / Network Protocols
  - Docker & DevOps basics
  - Python for Networking

fun_fact: I debug my life like my code 🐛
```
...
<!-- 3 ảnh ban đầu với style frame đẹp hơn -->
### 📸 Gallery
